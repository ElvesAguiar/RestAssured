...
public class ProductControllerRA {
	...
	public void setup() throws Exception {
		...
		clientToken = TokenUtil.obtenAcessToken(clientUsername, clientPassword);
		adminToken = TokenUtil.obtenAcessToken(adminUsername, adminPassword);
	...
	@Test
	public void insertShouldReturnProductCreatedWhenLoggedAsAdmin() throws Exception {
	...
	@Test
	public void updateShouldReturnProductWhenIdExistsAndAdminLogged() throws Exception {
